...
<!-- PROGRESS-START -->
```
Resident Evil CODE: Veronica X: 806 implemented functions / 3876 total (20.79%)
CRI ADX (March 13, 2001): 639 implemented functions / 663 total (96.38%)

Decomp progress: 1445 implemented functions / 4539 total (31.84%)
```
<!-- PROGRESS-END -->
