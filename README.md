...
<!-- PROGRESS-START -->
```
Resident Evil CODE: Veronica X: 804 implemented functions / 3876 total (20.74%)
CRI ADX (March 13, 2001): 605 implemented functions / 653 total (92.65%)

Decomp progress: 1409 implemented functions / 4529 total (31.11%)
```
<!-- PROGRESS-END -->
